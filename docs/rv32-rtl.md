...
**M5**, completed on 2026-09-21 on branch `m5-rv32-devices`: the core unchanged and the machine around it; 35 tests on each simulator, the self-check numbers above unchanged, the diagnostic at 1,666,415 cycles unstalled. Its record is [rv32-soc.md](rv32-soc.md).
